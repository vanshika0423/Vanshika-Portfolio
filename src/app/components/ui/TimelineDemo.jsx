    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
Developed a fully responsive and user-friendly frontend interface for seamless code editing, compilation, and
      ...
      content: (
        <div>
          <p
            ...
            Developed a machine learning model to detect fraudulent credit card transactions using real-world, imbalanced
 datasets.
          </p>
          <div className="mb-8">
            <div
